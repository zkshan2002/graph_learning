...
python3 main.py --tag='exp0 HAN_u1' --noise_u 0.1 \
--seed_list 100 200 300 400 500 600 700 800 900 1000

python3 main.py --tag='exp0 HAN_u2' --noise_u 0.2 \
--seed_list 100 200 300 400 500 600 700 800 900 1000

python3 main.py --tag='exp0 HAN_u3' --noise_u 0.3 \
--seed_list 100 200 300 400 500 600 700 800 900 1000

python3 main.py --tag='exp0 HAN_u4' --noise_u 0.4 \
--seed_list 100 200 300 400 500 600 700 800 900 1000

python3 main.py --tag='exp0 HAN_u5' --noise_u 0.5 \
--seed_list 100 200 300 400 500 600 700 800 900 1000
